 ...
 * @author Ramya
 */
public class MqttLiveDataRowMapper implements RowMapper<MqttLiveDTO> {

    EncryptDecrypt ed = new EncryptDecrypt();
    DatabaseUtil du = new DatabaseUtil();

    @Override
    public MqttLiveDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        MqttLiveDTO data = new MqttLiveDTO();
