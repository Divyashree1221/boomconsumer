 ...
 */
public class MappedVehiclesRowMapper implements RowMapper<MappedVehiclesDTO> {
    
    EncryptDecrypt ed = new EncryptDecrypt();

    @Override
    public MappedVehiclesDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        MappedVehiclesDTO data = new MappedVehiclesDTO();
