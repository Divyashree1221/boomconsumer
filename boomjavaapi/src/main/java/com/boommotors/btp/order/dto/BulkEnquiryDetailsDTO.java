...
@Setter
@NoArgsConstructor
public class BulkEnquiryDetailsDTO {

    private static final long serialVersionUID = 1L;

    @JsonProperty("bulk_enquiry_id")
    private Long bulkEnquiryId;
    ...
    @JsonProperty("model_accessories")
    private List<ModelAccessoriesDetailsDTO> modelAccessories;

    @JsonProperty("parts_colour_details")
    private List<VariantPartsColourDetailsDTO> partsColourDetails;
