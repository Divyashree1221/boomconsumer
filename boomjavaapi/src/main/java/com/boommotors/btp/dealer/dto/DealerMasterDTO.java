...
public class DealerMasterDTO {
    ...
    private List<DealerBankerDTO> dealerBankerInfo;

    @JsonProperty("dealer_personnel_info")
    private List<DealerKeyPersonnelDTO> dealerPersonnelInfo;

    @JsonProperty("dealer_reference_info")
    private List<DealerReferencesDTO> dealeReferenceInfo;
